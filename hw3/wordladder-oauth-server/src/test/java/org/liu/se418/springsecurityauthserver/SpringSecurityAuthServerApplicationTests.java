...
//	public final static String RESOURCE_SERVER = "http://localhost:8082/wordLadder";
//
//	@Test
//	public void givenUser_whenUseFooClient_thenOkForFooResourceOnly() {
//		final String accessToken = obtainAccessTokenWithAuthorizationCode("ClentId","secret", "john", "123");
//
...
//	}
//
//	private String obtainAccessTokenWithAuthorizationCode(String clientId, String secret, String username, String password) {
//		final String redirectUrl = "http://www.example.com";
//		final String authorizeUrl = AUTH_SERVER + "/oauth/authorize?response_type=code&client_id=" + clientId + "&redirect_uri=" + redirectUrl+"&secret="+secret;
